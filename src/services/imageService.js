 ...
 */
export async function generateExcuseImage(excuse) {
  ...
  // Excuse text (with word wrapping)
  ctx.fillStyle = '#ffffff';
  ...
  ctx.fillText('When you don\'t want to explain — blame the universe.', canvas.width / 2, canvas.height - 60);
